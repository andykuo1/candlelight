...
import apricot.base.window.input.InputManager;
...
public class OldishGameEngine implements OldTickHandler, OldRenderHandler
{
	...
	private final OldishGameHandler handler;

	public OldishGameEngine(OldishGameHandler handler)
	{

package apricot.base.input;

import apricot.base.window.input.Input;
import apricot.base.window.input.InputEngine;
import apricot.base.window.input.InputHandler;
import apricot.base.window.input.MouseHandler;
...
public class OldInputManager
{
	...
	private OldInputManager() {}

	public static void init(InputEngine inputEngine)
	{

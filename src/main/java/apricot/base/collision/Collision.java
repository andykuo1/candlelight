...
import apricot.bstone.util.function.TriFunction;
import apricot.bstone.util.pair.Pair;
...
public class Collision
{
	...
	static
	{
		...
		//register(Shape.Circle.class, Shape.Segment.class, Collision::canary.test);
		...
		//register(Shape.Segment.class, Shape.Point.class, Collision::canary.test);
		//register(Shape.Segment.class, Shape.Segment.class, Collision::canary.test);
		//register(Shape.Segment.class, Shape.AABB.class, Collision::canary.test);
		//register(Shape.Segment.class, Shape.Circle.class, Collision::canary.test);
	}

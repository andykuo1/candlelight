...
public class OldWindow
{
	...
	public static void setCurrentWindowContext(OldWindow window)
	{
	...
	private final ViewPort defaultViewPort = new ViewPort(0, 0, this.width, this.height){
		...
		public int getWidth()
		{
			return OldWindow.this.width;
		}

		@Override
		public int getHeight()
		{
			return OldWindow.this.height;
		}
	};
	...
	public OldWindow(String title, int width, int height)
	{
		this.width = width;
		this.height = height;

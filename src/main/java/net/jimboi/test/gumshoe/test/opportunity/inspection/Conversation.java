...
import net.jimboi.test.gumshoe.test.opportunity.inspection.memory.DerivedMemory;
import net.jimboi.test.gumshoe.test.opportunity.inspection.memory.Memory;
import net.jimboi.test.gumshoe.test.opportunity.inspection.memory.MemoryDatabase;
import net.jimboi.test.gumshoe.test.opportunity.inspection.memory.SensoryMemory;
import net.jimboi.test.gumshoe.test.opportunity.inspection.query.QueryString;

...
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentBillboard;
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentBounding;
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentHeading;
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentNavigator;
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentRenderable;
import net.jimboi.canary.stage_a.lantern.newglim.entity.component.EntityComponentTargeter;

...
import net.jimboi.canary.stage_a.lantern.newglim.entity.EntityBunny;
import net.jimboi.canary.stage_a.lantern.newglim.entity.EntityCrate;
import net.jimboi.canary.stage_a.lantern.newglim.entity.EntityGlim;
import net.jimboi.canary.stage_a.lantern.newglim.entity.EntityPlayer;
...
import net.jimboi.canary.stage_a.lantern.newglim.entity.system.EntitySystemBillboard;
import net.jimboi.canary.stage_a.lantern.newglim.entity.system.EntitySystemBounding;
import net.jimboi.canary.stage_a.lantern.newglim.entity.system.EntitySystemHeading;

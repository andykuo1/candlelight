 ...
 */
public class CandleRenderer extends RenderAssetBase
{
	...
	protected void onLoad(RenderEngine renderEngine)
	{
		...
		//Create 2dc
		{
			...
			Candle.ENGINE.getAssetManager().registerAsset(Mesh.class, "2dc", new MeshLoader.MeshParameter(mb.bake(false, true)));
		}
		mb.clear();
	}

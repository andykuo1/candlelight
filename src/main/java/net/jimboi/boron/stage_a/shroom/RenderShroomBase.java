 ...
 */
public abstract class RenderShroomBase extends RenderBase
{
	...
	{
		return (PerspectiveCamera) super.getMainCamera();
	}

	@Override
	protected SceneShroomBase getScene()
	{
		return (SceneShroomBase) super.getScene();
	}
}

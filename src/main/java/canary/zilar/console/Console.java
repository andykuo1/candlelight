...
public class Console extends CommandHandler implements Runnable
{
	...
	private float typeWriterDelayMult = 1;
	...
	public Console setTypeWriterDelayMultiplier(float multiplier)
	{
		this.typeWriterDelayMult = multiplier;
		return this;
	}
	...
	protected void print(String msg, javax.swing.text.AttributeSet attrib)
	{
		...
		if (this.typeWriter && !(attrib instanceof TextAttribute))
		{
			...
			for(char c : msg.toCharArray())
			{
				...
				try
				{
					Thread.sleep((int) (this.typeWriterDelayHandler.apply(c) * this.typeWriterDelayMult));
				}
				catch (InterruptedException e)
				{
				}

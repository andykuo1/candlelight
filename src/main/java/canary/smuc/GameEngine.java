...
import canary.bstone.application.game.Game;
...
public class GameEngine implements Framework, Game
{
	...
	public void onApplicationStart(Application app)
	{
		...
		this.getRenderServices().startService("framework", new Render(this));
		...
		this.getTickServices().startService("framework", new Tick(this));

...
import canary.test.sleuth.cluedo.GameOfMotive;
import canary.test.sleuth.cluedo.GameOfOpportunity;
import canary.test.sleuth.cluedo.Room;
import canary.test.sleuth.cluedo.Venue;
import canary.test.sleuth.cluedo.VenueFactory;
import canary.test.sleuth.data.BodyPart;

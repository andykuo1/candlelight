package boron.minicraft.ld22;

import boron.minicraft.ld22.entity.Player;
import boron.minicraft.ld22.gfx.Color;
import boron.minicraft.ld22.gfx.Screen;
import boron.minicraft.ld22.gfx.SpriteSheet;
import boron.minicraft.ld22.level.Level;
import boron.minicraft.ld22.level.tile.Tile;
import boron.minicraft.ld22.screen.DeadMenu;
import boron.minicraft.ld22.screen.LevelTransitionMenu;
import boron.minicraft.ld22.screen.Menu;
import boron.minicraft.ld22.screen.TitleMenu;
import boron.minicraft.ld22.screen.WonMenu;

import boron.minicraft.MiniCraft;
import boron.minicraft.MiniRenderer;
...
public class Game
{
	...
	public void setMenu(Menu menu) {
		this.menu = menu;
		if (menu != null) menu.init(this, MiniCraft.getMiniCraft().inputManager);
	}
	...
	public void resetGame() {
		...
		player = new Player(this, MiniCraft.getMiniCraft().inputManager);
	...
	public void init() {
		...
		screen = new Screen(WIDTH, HEIGHT, new SpriteSheet(MiniCraft.getMiniCraft().renderer.bmpIcons));
		lightScreen = new Screen(WIDTH, HEIGHT, new SpriteSheet(MiniCraft.getMiniCraft().renderer.bmpIcons));
	...
	public void render(MiniRenderer renderer)
	{
		...
		renderer.drawScreen(this.pixels, WIDTH, HEIGHT);
	}

...
public class Zombie extends MovingMob {
	private int lvl;
	...
	public void tick() {
		...
		if (!move(accX * speed, accY * speed) || random.nextInt(200) == 0) {
			randomWalkTime = 60;
			accX = (random.nextInt(3) - 1) * random.nextInt(2);
			accY = (random.nextInt(3) - 1) * random.nextInt(2);
		}

...
public class MouseHandler extends InputHandler
{
	...
	MouseHandler(InputEngine inputEngine)
	{
		super(inputEngine);

		Window window = inputEngine.getWindow();
	...
	public void setCursorMode(boolean locked)
	{
		...
		this.locked = locked;
		GLFW.glfwSetInputMode(this.inputEngine.getWindow().handle(), GLFW.GLFW_CURSOR, this.locked ? GLFW.GLFW_CURSOR_DISABLED : GLFW.GLFW_CURSOR_NORMAL);
	}
